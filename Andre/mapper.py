...
def set_resized_world_x(n):
    ...
    if n > get_world_size():
        quick_print("resized_world_x above maximum value, adjusting to max possible value instead")
...
def set_resized_world_y(n):
    ...
    if n > get_world_size():
        quick_print("resized_world_y above maximum value, adjusting to max possible value instead")
